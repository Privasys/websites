    ...
    useEffect(() => {
        ...
        void (async () => {
            ...
            mermaid.initialize({
                ...
                fontFamily: 'inherit',
                // Diagram text at ~80% of the 16px body text. Both settings
                // are needed in mermaid 11: sequence diagrams only honour the
                // top-level fontSize (their sequence.*FontSize options are
                // ignored), while flowchart/state only honour
