...
The fastest way to try Privasys is the [CLI](/cli). Four commands take you from nothing to a deployed, hardware-attested confidential app:
...
The CLI is also an [MCP server](/cli/agents), so an AI agent can drive the whole platform: run `privasys agents init` in your project and ask your agent to deploy a confidential app.
...
<Cards>
  <Card title="Privasys CLI" href="/cli">
