...
5. Writes the validated root hash to `/var/lib/enclave-os/model-roothashes/<name>.roothash` so the confidential-ai proxy can surface it via OID `1.3.6.1.4.1.65230.3.5.5`.
