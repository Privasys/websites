...
| `1.3.6.1.4.1.65230.1.1` | Config Merkle Root | The 32-byte SHA-256 Merkle root covering all enclave configuration (CA cert, CA key, WASM app hashes). |
| `1.3.6.1.4.1.65230.2.{N}` | WASM Module | Per-application entries. `2.1` = app name, `2.2` = app route prefix, `2.3` = SHA-256 code hash of the WASM binary. |
...
6. Build X.509 certificate:
   ...
   - Attach WASM module extensions (OID 1.3.6.1.4.1.65230.2.*)
...
5. **Optionally checking the Merkle root** (OID `1.3.6.1.4.1.65230.1.1`) to verify the enclave's configuration.
