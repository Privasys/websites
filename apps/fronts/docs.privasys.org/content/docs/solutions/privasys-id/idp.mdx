...
Without this check, the JWT would not constitute proof of attestation verification — see [Technology > Sealed Session](/technology/sealed-session) for the full trust argument.
