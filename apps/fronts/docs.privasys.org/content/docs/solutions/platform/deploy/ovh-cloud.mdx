...
This guide deploys the [RA-TLS for Caddy](https://github.com/Privasys/ra-tls-caddy) module on an OVH dedicated server using Intel TDX with a QEMU/KVM Confidential VM.
...
2. Select a server with a **4th Gen Intel Xeon Scalable** (or newer), such as `Advance-1`, `Scale-1`
