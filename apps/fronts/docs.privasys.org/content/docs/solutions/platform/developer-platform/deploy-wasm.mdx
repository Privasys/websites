...
The deployed application's code hash is embedded in the app's RA-TLS leaf certificate under these OIDs:
...
The platform certificate additionally carries the combined workloads hash (OID `1.3.6.1.4.1.65230.2.5`) covering all deployed apps.
