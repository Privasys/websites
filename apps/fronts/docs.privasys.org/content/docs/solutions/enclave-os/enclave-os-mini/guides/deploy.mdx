...
See the [Layer 4 Proxy Guide](/solutions/enclave-os/guides/layer4-proxy) for Caddy (caddy-l4) and HAProxy configurations.

## Loading WASM Apps

The enclave starts **empty**; no WASM apps are compiled in. Apps are loaded at runtime over the RA-TLS connection. See [Build a WASM App](/solutions/enclave-os/guides/build-wasm-app) for the full workflow.
