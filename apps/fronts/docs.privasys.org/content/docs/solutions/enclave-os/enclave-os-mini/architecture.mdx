...
See the [Layer 4 Proxy guide](/solutions/enclave-os/guides/layer4-proxy) for Caddy (caddy-l4) and HAProxy configurations, including SNI-based routing for multiple enclave instances.
