...
3. Embedded in the app's RA-TLS leaf certificate as a custom X.509 extension (OID `1.3.6.1.4.1.65230.3.2`); the platform certificate additionally carries the combined workloads hash (OID `1.3.6.1.4.1.65230.2.5`).
