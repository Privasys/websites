...
| `1.3.6.1.4.1.65230.3.7` | `TOOLS_DIGEST` | SHA-256 over the canonical, sorted JSON of the configured MCP tool servers, so a verifier can prove exactly which tools the AI enclave exposes. |
