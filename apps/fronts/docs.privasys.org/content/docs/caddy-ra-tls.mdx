...
| **RA-TLS cert** | CA-signed, enclave-generated| CA-signed, TEE-generated|
...
- [Google Cloud (TDX)](https://github.com/Privasys/ra-tls-caddy/blob/main/install/Google%20Cloud.md) — GCP Confidential VMs (c3-standard)
- [Azure (TDX)](https://github.com/Privasys/ra-tls-caddy/blob/main/install/Azure.md) — Azure DCesv5/DCedsv5 Confidential VMs
- [OVH Cloud (Bare Metal)](https://github.com/Privasys/ra-tls-caddy/blob/main/install/OVH%20Cloud.md) — Dedicated servers with QEMU/KVM TDX guests
