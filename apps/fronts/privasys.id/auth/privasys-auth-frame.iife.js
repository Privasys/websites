...
`}return W.substring(0,W.length-1)},v.renderTo2dContext=function(c,h){h=h||2;for(var i=v.getModuleCount(),p=0;p<i;p++)for(var u=0;u<i;u++)c.fillStyle=v.isDark(p,u)?"black":"white",c.fillRect(p*h,u*h,h,h)},v};f.stringToBytesFuncs={default:function(k){for(var A=[],w=0;w<k.length;w+=1){var b=k.charCodeAt(w);A.push(b&255)}return A}},f.stringToBytes=f.stringToBytesFuncs.default,f.createStringToBytes=function(k,A){var w=(function(){for(var o=ce(k),m=function(){var L=o.read();if(L==-1)throw"eof";return L},n=0,r={};;){var g=o.read();if(g==-1)break;var d=m(),v=m(),N=m(),B=String.fromCharCode(g<<8|d),M=v<<8|N;r[B]=M,n+=1}if(n!=A)throw n+" != "+A;return r})(),b=63;return function(o){for(var m=[],n=0;n<o.length;n+=1){var r=o.charCodeAt(n);if(r<128)m.push(r);else{var g=w[o.charAt(n)];typeof g=="number"?(g&255)==g?m.push(g):(m.push(g>>>8),m.push(g&255)):m.push(b)}}return m}};var e={MODE_NUMBER:1,MODE_ALPHA_NUM:2,MODE_8BIT_BYTE:4,MODE_KANJI:8},t={L:1,M:0,Q:3,H:2},s={PATTERN000:0,PATTERN001:1,PATTERN010:2,PATTERN011:3,PATTERN100:4,PATTERN101:5,PATTERN110:6,PATTERN111:7},l=(function(){var k=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],A=1335,w=7973,b=21522,o={},m=function(n){for(var r=0;n!=0;)r+=1,n>>>=1;return r};return o.getBCHTypeInfo=function(n){for(var r=n<<10;m(r)-m(A)>=0;)r^=A<<m(r)-m(A);return(n<<10|r)^b},o.getBCHTypeNumber=function(n){for(var r=n<<12;m(r)-m(w)>=0;)r^=w<<m(r)-m(w);return n<<12|r},o.getPatternPosition=function(n){return k[n-1]},o.getMaskFunction=function(n){switch(n){case s.PATTERN000:return function(r,g){return(r+g)%2==0};case s.PATTERN001:return function(r,g){return r%2==0};case s.PATTERN010:return function(r,g){return g%3==0};case s.PATTERN011:return function(r,g){return(r+g)%3==0};case s.PATTERN100:return function(r,g){return(Math.floor(r/2)+Math.floor(g/3))%2==0};case s.PATTERN101:return function(r,g){return r*g%2+r*g%3==0};case s.PATTERN110:return function(r,g){return(r*g%2+r*g%3)%2==0};case s.PATTERN111:return function(r,g){return(r*g%3+(r+g)%2)%2==0};default:throw"bad maskPattern:"+n}},o.getErrorCorrectPolynomial=function(n){for(var r=I([1],0),g=0;g<n;g+=1)r=r.multiply(I([1,a.gexp(g)],0));return r},o.getLengthInBits=function(n,r){if(1<=r&&r<10)switch(n){case e.MODE_NUMBER:return 10;case e.MODE_ALPHA_NUM:return 9;case e.MODE_8BIT_BYTE:return 8;case e.MODE_KANJI:return 8;default:throw"mode:"+n}else if(r<27)switch(n){case e.MODE_NUMBER:return 12;case e.MODE_ALPHA_NUM:return 11;case e.MODE_8BIT_BYTE:return 16;case e.MODE_KANJI:return 10;default:throw"mode:"+n}else if(r<41)switch(n){case e.MODE_NUMBER:return 14;case e.MODE_ALPHA_NUM:return 13;case e.MODE_8BIT_BYTE:return 16;case e.MODE_KANJI:return 12;default:throw"mode:"+n}else throw"type:"+r},o.getLostPoint=function(n){for(var r=n.getModuleCount(),g=0,d=0;d<r;d+=1)for(var v=0;v<r;v+=1){for(var N=0,B=n.isDark(d,v),M=-1;M<=1;M+=1)if(!(d+M<0||r<=d+M))for(var L=-1;L<=1;L+=1)v+L<0||r<=v+L||M==0&&L==0||B==n.isDark(d+M,v+L)&&(N+=1);N>5&&(g+=3+N-5)}for(var d=0;d<r-1;d+=1)for(var v=0;v<r-1;v+=1){var U=0;n.isDark(d,v)&&(U+=1),n.isDark(d+1,v)&&(U+=1),n.isDark(d,v+1)&&(U+=1),n.isDark(d+1,v+1)&&(U+=1),(U==0||U==4)&&(g+=3)}for(var d=0;d<r;d+=1)for(var v=0;v<r-6;v+=1)n.isDark(d,v)&&!n.isDark(d,v+1)&&n.isDark(d,v+2)&&n.isDark(d,v+3)&&n.isDark(d,v+4)&&!n.isDark(d,v+5)&&n.isDark(d,v+6)&&(g+=40);for(var v=0;v<r;v+=1)for(var d=0;d<r-6;d+=1)n.isDark(d,v)&&!n.isDark(d+1,v)&&n.isDark(d+2,v)&&n.isDark(d+3,v)&&n.isDark(d+4,v)&&!n.isDark(d+5,v)&&n.isDark(d+6,v)&&(g+=40);for(var H=0,v=0;v<r;v+=1)for(var d=0;d<r;d+=1)n.isDark(d,v)&&(H+=1);var $=Math.abs(100*H/r/r-50)/5;return g+=$*10,g},o})(),a=(function(){for(var k=new Array(256),A=new Array(256),w=0;w<8;w+=1)k[w]=1<<w;for(var w=8;w<256;w+=1)k[w]=k[w-4]^k[w-5]^k[w-6]^k[w-8];for(var w=0;w<255;w+=1)A[k[w]]=w;var b={};return b.glog=function(o){if(o<1)throw"glog("+o+")";return A[o]},b.gexp=function(o){for(;o<0;)o+=255;for(;o>=256;)o-=255;return k[o]},b})();function I(k,A){if(typeof k.length>"u")throw k.length+"/"+A;var w=(function(){for(var o=0;o<k.length&&k[o]==0;)o+=1;for(var m=new Array(k.length-o+A),n=0;n<k.length-o;n+=1)m[n]=k[n+o];return m})(),b={};return b.getAt=function(o){return w[o]},b.getLength=function(){return w.length},b.multiply=function(o){for(var m=new Array(b.getLength()+o.getLength()-1),n=0;n<b.getLength();n+=1)for(var r=0;r<o.getLength();r+=1)m[n+r]^=a.gexp(a.glog(b.getAt(n))+a.glog(o.getAt(r)));return I(m,0)},b.mod=function(o){if(b.getLength()-o.getLength()<0)return b;for(var m=a.glog(b.getAt(0))-a.glog(o.getAt(0)),n=new Array(b.getLength()),r=0;r<b.getLength();r+=1)n[r]=b.getAt(r);for(var r=0;r<o.getLength();r+=1)n[r]^=a.gexp(a.glog(o.getAt(r))+m);return I(n,0).mod(o)},b}var P=(function(){var k=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12,7,37,13],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],A=function(o,m){var n={};return n.totalCount=o,n.dataCount=m,n},w={},b=function(o,m){switch(m){case t.L:return k[(o-1)*4+0];case t.M:return k[(o-1)*4+1];case t.Q:return k[(o-1)*4+2];case t.H:return k[(o-1)*4+3];default:return}};return w.getRSBlocks=function(o,m){var n=b(o,m);if(typeof n>"u")throw"bad rs block @ typeNumber:"+o+"/errorCorrectionLevel:"+m;for(var r=n.length/3,g=[],d=0;d<r;d+=1)for(var v=n[d*3+0],N=n[d*3+1],B=n[d*3+2],M=0;M<v;M+=1)g.push(A(N,B));return g},w})(),S=function(){var k=[],A=0,w={};return w.getBuffer=function(){return k},w.getAt=function(b){var o=Math.floor(b/8);return(k[o]>>>7-b%8&1)==1},w.put=function(b,o){for(var m=0;m<o;m+=1)w.putBit((b>>>o-m-1&1)==1)},w.getLengthInBits=function(){return A},w.putBit=function(b){var o=Math.floor(A/8);k.length<=o&&k.push(0),b&&(k[o]|=128>>>A%8),A+=1},w},_=function(k){var A=e.MODE_NUMBER,w=k,b={};b.getMode=function(){return A},b.getLength=function(n){return w.length},b.write=function(n){for(var r=w,g=0;g+2<r.length;)n.put(o(r.substring(g,g+3)),10),g+=3;g<r.length&&(r.length-g==1?n.put(o(r.substring(g,g+1)),4):r.length-g==2&&n.put(o(r.substring(g,g+2)),7))};var o=function(n){for(var r=0,g=0;g<n.length;g+=1)r=r*10+m(n.charAt(g));return r},m=function(n){if("0"<=n&&n<="9")return n.charCodeAt(0)-48;throw"illegal char :"+n};return b},R=function(k){var A=e.MODE_ALPHA_NUM,w=k,b={};b.getMode=function(){return A},b.getLength=function(m){return w.length},b.write=function(m){for(var n=w,r=0;r+1<n.length;)m.put(o(n.charAt(r))*45+o(n.charAt(r+1)),11),r+=2;r<n.length&&m.put(o(n.charAt(r)),6)};var o=function(m){if("0"<=m&&m<="9")return m.charCodeAt(0)-48;if("A"<=m&&m<="Z")return m.charCodeAt(0)-65+10;switch(m){case" ":return 36;case"$":return 37;case"%":return 38;case"*":return 39;case"+":return 40;case"-":return 41;case".":return 42;case"/":return 43;case":":return 44;default:throw"illegal char :"+m}};return b},Y=function(k){var A=e.MODE_8BIT_BYTE,w=k,b=f.stringToBytes(k),o={};return o.getMode=function(){return A},o.getLength=function(m){return b.length},o.write=function(m){for(var n=0;n<b.length;n+=1)m.put(b[n],8)},o},Q=function(k){var A=e.MODE_KANJI,w=k,b=f.stringToBytesFuncs.SJIS;if(!b)throw"sjis not supported.";(function(n,r){var g=b(n);if(g.length!=2||(g[0]<<8|g[1])!=r)throw"sjis not supported."})("\u53CB",38726);var o=b(k),m={};return m.getMode=function(){return A},m.getLength=function(n){return~~(o.length/2)},m.write=function(n){for(var r=o,g=0;g+1<r.length;){var d=(255&r[g])<<8|255&r[g+1];if(33088<=d&&d<=40956)d-=33088;else if(57408<=d&&d<=60351)d-=49472;else throw"illegal char at "+(g+1)+"/"+d;d=(d>>>8&255)*192+(d&255),n.put(d,13),g+=2}if(g<r.length)throw"illegal char at "+(g+1)},m},V=function(){var k=[],A={};return A.writeByte=function(w){k.push(w&255)},A.writeShort=function(w){A.writeByte(w),A.writeByte(w>>>8)},A.writeBytes=function(w,b,o){b=b||0,o=o||w.length;for(var m=0;m<o;m+=1)A.writeByte(w[m+b])},A.writeString=function(w){for(var b=0;b<w.length;b+=1)A.writeByte(w.charCodeAt(b))},A.toByteArray=function(){return k},A.toString=function(){var w="";w+="[";for(var b=0;b<k.length;b+=1)b>0&&(w+=","),w+=k[b];return w+="]",w},A},te=function(){var k=0,A=0,w=0,b="",o={},m=function(r){b+=String.fromCharCode(n(r&63))},n=function(r){if(!(r<0)){if(r<26)return 65+r;if(r<52)return 97+(r-26);if(r<62)return 48+(r-52);if(r==62)return 43;if(r==63)return 47}throw"n:"+r};return o.writeByte=function(r){for(k=k<<8|r&255,A+=8,w+=1;A>=6;)m(k>>>A-6),A-=6},o.flush=function(){if(A>0&&(m(k<<6-A),k=0,A=0),w%3!=0)for(var r=3-w%3,g=0;g<r;g+=1)b+="="},o.toString=function(){return b},o},ce=function(k){var A=k,w=0,b=0,o=0,m={};m.read=function(){for(;o<8;){if(w>=A.length){if(o==0)return-1;throw"unexpected end of file./"+o}var r=A.charAt(w);if(w+=1,r=="=")return o=0,-1;if(r.match(/^\s$/))continue;b=b<<6|n(r.charCodeAt(0)),o+=6}var g=b>>>o-8&255;return o-=8,g};var n=function(r){if(65<=r&&r<=90)return r-65;if(97<=r&&r<=122)return r-97+26;if(48<=r&&r<=57)return r-48+52;if(r==43)return 62;if(r==47)return 63;throw"c:"+r};return m},de=function(k,A){var w=k,b=A,o=new Array(k*A),m={};m.setPixel=function(d,v,N){o[v*w+d]=N},m.write=function(d){d.writeString("GIF87a"),d.writeShort(w),d.writeShort(b),d.writeByte(128),d.writeByte(0),d.writeByte(0),d.writeByte(0),d.writeByte(0),d.writeByte(0),d.writeByte(255),d.writeByte(255),d.writeByte(255),d.writeString(","),d.writeShort(0),d.writeShort(0),d.writeShort(w),d.writeShort(b),d.writeByte(0);var v=2,N=r(v);d.writeByte(v);for(var B=0;N.length-B>255;)d.writeByte(255),d.writeBytes(N,B,255),B+=255;d.writeByte(N.length-B),d.writeBytes(N,B,N.length-B),d.writeByte(0),d.writeString(";")};var n=function(d){var v=d,N=0,B=0,M={};return M.write=function(L,U){if(L>>>U)throw"length over";for(;N+U>=8;)v.writeByte(255&(L<<N|B)),U-=8-N,L>>>=8-N,B=0,N=0;B=L<<N|B,N=N+U},M.flush=function(){N>0&&v.writeByte(B)},M},r=function(d){for(var v=1<<d,N=(1<<d)+1,B=d+1,M=g(),L=0;L<v;L+=1)M.add(String.fromCharCode(L));M.add(String.fromCharCode(v)),M.add(String.fromCharCode(N));var U=V(),H=n(U);H.write(v,B);var $=0,j=String.fromCharCode(o[$]);for($+=1;$<o.length;){var J=String.fromCharCode(o[$]);$+=1,M.contains(j+J)?j=j+J:(H.write(M.indexOf(j),B),M.size()<4095&&(M.size()==1<<B&&(B+=1),M.add(j+J)),j=J)}return H.write(M.indexOf(j),B),H.write(N,B),H.flush(),U.toByteArray()},g=function(){var d={},v=0,N={};return N.add=function(B){if(N.contains(B))throw"dup key:"+B;d[B]=v,v+=1},N.size=function(){return v},N.indexOf=function(B){return d[B]},N.contains=function(B){return typeof d[B]<"u"},N};return m},ie=function(k,A,w){for(var b=de(k,A),o=0;o<A;o+=1)for(var m=0;m<k;m+=1)b.setPixel(m,o,w(m,o));var n=V();b.write(n);for(var r=te(),g=n.toByteArray(),d=0;d<g.length;d+=1)r.writeByte(g[d]);return r.flush(),"data:image/gif;base64,"+r};return f})();(function(){Ce.stringToBytesFuncs["UTF-8"]=function(f){function e(t){for(var s=[],l=0;l<t.length;l++){var a=t.charCodeAt(l);a<128?s.push(a):a<2048?s.push(192|a>>6,128|a&63):a<55296||a>=57344?s.push(224|a>>12,128|a>>6&63,128|a&63):(l++,a=65536+((a&1023)<<10|t.charCodeAt(l)&1023),s.push(240|a>>18,128|a>>12&63,128|a>>6&63,128|a&63))}return s}return e(f)}})();(function(f){typeof define=="function"&&define.amd?define([],f):typeof Te=="object"&&(Ee.exports=f())})(function(){return Ce})});function pe(){let f=new Uint8Array(32);return crypto.getRandomValues(f),Array.from(f,e=>e.toString(16).padStart(2,"0")).join("")}var je="privasys.id";function xe(f){let e=btoa(f).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return`https://${je}/scp?p=${e}`}function ke(f){let e=f.sessionId??pe(),t={origin:f.rpId,sessionId:e,rpId:f.rpId,brokerUrl:f.brokerUrl};return f.requestedAttributes?.length&&(t.requestedAttributes=f.requestedAttributes),f.appName&&(t.appName=f.appName),f.privacyPolicyUrl&&(t.privacyPolicyUrl=f.privacyPolicyUrl),{sessionId:e,payload:xe(JSON.stringify(t))}}function Ae(f){let e=f.sessionId??pe(),t=f.apps.map(l=>({rpId:l.rpId,sessionId:l.sessionId??pe()})),s={origin:f.apps[0]?.rpId??"",sessionId:e,brokerUrl:f.brokerUrl,apps:t};return{sessionId:e,appSessions:t,payload:xe(JSON.stringify(s))}}var ue="privasys_sessions",fe="privasys_device_hints",G=class{constructor(){this.listeners=new Set}store(e){let t=this.getAll(),s=t.findIndex(l=>l.rpId===e.rpId);s>=0?t[s]=e:t.push(e),this.persist(t),this.notify(t)}get(e){return this.getAll().find(t=>t.rpId===e)}getAll(){try{let e=localStorage.getItem(ue);return e?JSON.parse(e):[]}catch{return[]}}has(e){return this.get(e)!==void 0}findPushToken(){let e=this.getAll().filter(t=>!!t.pushToken).sort((t,s)=>s.authenticatedAt-t.authenticatedAt);return e[0]?.pushToken?e[0].pushToken:this.getDeviceHint()?.pushToken}remove(e){let t=this.getAll().filter(s=>s.rpId!==e);this.persist(t),this.notify(t)}clear(){localStorage.removeItem(ue),this.notify([])}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}saveDeviceHint(e,t){let s={pushToken:e,brokerUrl:t,updatedAt:Date.now()};try{localStorage.setItem(fe,JSON.stringify(s))}catch{}}getDeviceHint(){try{let e=localStorage.getItem(fe);return e?JSON.parse(e):void 0}catch{return}}clearDeviceHint(){localStorage.removeItem(fe)}persist(e){localStorage.setItem(ue,JSON.stringify(e))}notify(e){for(let t of this.listeners)t(e)}};var ge=12e4,ae=class{constructor(e,t={}){this.activeConnections=new Map;this.config={attestation:"required",timeout:ge,...e},this.events=t,this.sessions=new G}createQR(e){return ke({rpId:this.config.rpId,brokerUrl:this.config.brokerUrl,sessionId:e,requestedAttributes:this.config.requestedAttributes,appName:this.config.appName,privacyPolicyUrl:this.config.privacyPolicyUrl})}waitForResult(e){return new Promise((t,s)=>{let l=this.config.timeout??ge,a=new URL(this.config.brokerUrl);a.searchParams.set("session",e),a.searchParams.set("role","browser");let I=new WebSocket(a.toString());this.activeConnections.set(e,I),this.setState("waiting-for-scan");let P=setTimeout(()=>{this.setState("timeout"),this.cleanup(e),s(new Error("Authentication timed out"))},l);I.onopen=()=>{this.setState("waiting-for-scan")},I.onmessage=S=>{try{let _=JSON.parse(typeof S.data=="string"?S.data:"{}");this.handleMessage(e,_,t,P)}catch{}},I.onerror=()=>{clearTimeout(P),this.setState("error"),this.cleanup(e),s(new Error("WebSocket connection failed"))},I.onclose=S=>{clearTimeout(P),this.cleanup(e),S.code!==1e3&&(this.setState("error"),s(new Error(`Connection closed (code ${S.code})`)))}})}async notifyAndWait(e,t){let s=t??this.createQR().sessionId,l=this.config.brokerUrl.replace("wss://","https://").replace("ws://","http://").replace(/\/relay\/?$/,""),a=await fetch(`${l}/notify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({pushToken:e,sessionId:s,rpId:this.config.rpId,appName:this.config.appName,origin:this.config.rpId,brokerUrl:this.config.brokerUrl})});if(!a.ok){let I=await a.text();throw new Error(`Push notification failed: ${I}`)}return this.waitForResult(s)}cancel(e){this.cleanup(e),this.setState("idle")}destroy(){for(let e of this.activeConnections.keys())this.cleanup(e);this.setState("idle")}getMultiple(e){let{sessionId:t,appSessions:s,payload:l}=Ae({brokerUrl:this.config.brokerUrl,apps:e.map(I=>({rpId:I.rpId}))}),a=this.waitForBatch(s);return{sessionId:t,appSessions:s,payload:l,result:a}}on(e){this.events={...this.events,...e}}handleMessage(e,t,s,l){switch(t.type){case"peer-joined":case"wallet-waiting":this.setState("wallet-connected");break;case"auth-result":{clearTimeout(l),this.setState("complete");let a={sessionToken:t.sessionToken,sessionId:e,attestation:t.attestation,pushToken:t.pushToken||void 0,attributes:t.attributes||void 0};this.sessions.store({token:a.sessionToken,rpId:this.config.rpId,origin:globalThis.location?.origin??"",authenticatedAt:Date.now(),pushToken:a.pushToken,brokerUrl:this.config.brokerUrl}),this.events.onAuthenticated?.(a),this.cleanup(e),s(a);break}case"auth-error":{clearTimeout(l),this.setState("error"),this.cleanup(e);let a=new Error(t.message??"Authentication failed");this.events.onError?.(a);break}case"authenticating":this.setState("authenticating");break}}setState(e){this.events.onStateChange?.(e)}async waitForBatch(e){let t=this.config.timeout??ge;this.setState("waiting-for-scan");let s=await Promise.allSettled(e.map(I=>Promise.race([this.waitForResult(I.sessionId),new Promise((P,S)=>setTimeout(()=>S(new Error("Batch item timed out")),t))]))),l=[],a=[];for(let I=0;I<s.length;I++){let P=s[I];P.status==="fulfilled"?l.push(P.value):a.push({rpId:e[I].rpId,error:P.reason instanceof Error?P.reason.message:String(P.reason)})}return this.setState(a.length===0?"complete":"error"),{results:l,errors:a}}cleanup(e){let t=this.activeConnections.get(e);t&&((t.readyState===WebSocket.OPEN||t.readyState===WebSocket.CONNECTING)&&t.close(1e3),this.activeConnections.delete(e))}};function K(f){let e=new Uint8Array(f),t="";for(let s=0;s<e.length;s++)t+=String.fromCharCode(e[s]);return btoa(t).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function re(f){let e=f.replace(/-/g,"+").replace(/_/g,"/");for(;e.length%4!==0;)e+="=";let t=atob(e),s=new Uint8Array(t.length);for(let l=0;l<t.length;l++)s[l]=t.charCodeAt(l);return s.buffer}function Ie(f){let e=new Uint8Array(f);return crypto.getRandomValues(e),Array.from(e,t=>t.toString(16).padStart(2,"0")).join("")}var ee=class{constructor(e,t={}){this.state="idle";this.config={timeout:6e4,...e},this.events=t,this.sessions=new G}on(e){this.events={...this.events,...e}}getState(){return this.state}async register(e){this.setState("requesting-options");try{let t=K(crypto.getRandomValues(new Uint8Array(32)).buffer),s=this.config.sessionId??Ie(16),a=(await this.fido2Fetch("register/begin",{userName:e??globalThis.location?.hostname??"user",userHandle:t},{session_id:s})).publicKey;if(!a)throw new Error("Missing publicKey in registration options");let I={publicKey:{challenge:re(a.challenge),rp:{id:a.rp.id,name:a.rp.name},user:{id:re(a.user.id),name:a.user.name,displayName:a.user.displayName??a.user.name},pubKeyCredParams:(a.pubKeyCredParams??[]).map(R=>({type:R.type??"public-key",alg:R.alg})),timeout:this.config.timeout,attestation:a.attestation??"none",authenticatorSelection:{authenticatorAttachment:"platform",residentKey:a.authenticatorSelection?.residentKey??"preferred",userVerification:a.authenticatorSelection?.userVerification??"preferred"},...a.excludeCredentials?{excludeCredentials:a.excludeCredentials.map(R=>({type:"public-key",id:re(R.id)}))}:{}}};this.setState("ceremony");let P=await navigator.credentials.create(I);if(!P)throw new Error("No credential returned");this.setState("verifying");let S=P.response,_=await this.fido2Fetch("register/complete",{id:K(P.rawId),rawId:K(P.rawId),type:"public-key",response:{attestationObject:K(S.attestationObject),clientDataJSON:K(S.clientDataJSON)}},{challenge:a.challenge});return this.complete(_.sessionToken??"",s)}catch(t){return this.fail(t)}}async authenticate(){this.setState("requesting-options");try{let e=this.config.sessionId??Ie(16),s=(await this.fido2Fetch("authenticate/begin",{},{session_id:e})).publicKey;if(!s)throw new Error("Missing publicKey in authentication options");let l={publicKey:{challenge:re(s.challenge),rpId:s.rpId,timeout:this.config.timeout,userVerification:s.userVerification??"preferred",...s.allowCredentials?.length?{allowCredentials:s.allowCredentials.map(S=>({type:"public-key",id:re(S.id),...S.transports?.length?{transports:S.transports}:{}}))}:{}}};this.setState("ceremony");let a=await navigator.credentials.get(l);if(!a)throw new Error("No assertion returned");this.setState("verifying");let I=a.response,P=await this.fido2Fetch("authenticate/complete",{id:K(a.rawId),rawId:K(a.rawId),type:"public-key",response:{clientDataJSON:K(I.clientDataJSON),authenticatorData:K(I.authenticatorData),signature:K(I.signature)}},{challenge:s.challenge});return this.complete(P.sessionToken??"",e)}catch(e){return this.fail(e)}}static isSupported(){return typeof globalThis.PublicKeyCredential<"u"}async fido2Fetch(e,t,s){let l=(this.config.fido2Base??this.config.apiBase).replace(/\/+$/,""),a=this.config.fido2Base?new URL(`${l}/${e}`):new URL(`${l}/api/v1/apps/${encodeURIComponent(this.config.appName)}/fido2/${e}`);if(s)for(let[P,S]of Object.entries(s))a.searchParams.set(P,S);let I=await fetch(a.toString(),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!I.ok){let P=await I.json().catch(()=>({error:I.statusText}));throw new Error(P.error??`HTTP ${I.status}`)}return I.json()}complete(e,t){this.setState("complete");let s={sessionToken:e,sessionId:t};return this.sessions.store({token:e,rpId:this.config.appName,origin:globalThis.location?.origin??"",authenticatedAt:Date.now()}),this.events.onAuthenticated?.(s),s}fail(e){this.setState("error");let t=e instanceof Error?e.name==="NotAllowedError"?new Error("Credential operation was cancelled or timed out"):e:new Error(String(e));throw this.events.onError?.(t),t}setState(e){this.state=e,this.events.onStateChange?.(e)}};var Be=$e(Se(),1),We=`
