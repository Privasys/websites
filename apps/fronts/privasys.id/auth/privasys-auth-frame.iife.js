"use strict";(()=>{var At=Object.create;var je=Object.defineProperty;var Ct=Object.getOwnPropertyDescriptor;var It=Object.getOwnPropertyNames;var St=Object.getPrototypeOf,Et=Object.prototype.hasOwnProperty;var Bt=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports);var Tt=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of It(e))!Et.call(r,s)&&s!==t&&je(r,s,{get:()=>e[s],enumerable:!(n=Ct(e,s))||n.enumerable});return r};var Pt=(r,e,t)=>(t=r!=null?At(St(r)):{},Tt(e||!r||!r.__esModule?je(t,"default",{value:r,enumerable:!0}):t,r));var ct=Bt((ot,at)=>{var it=(function(){var r=function(A,E){var x=236,y=17,l=A,m=t[E],a=null,o=0,b=null,h=[],v={},_=function(u,p){o=l*4+17,a=(function(d){for(var f=new Array(d),g=0;g<d;g+=1){f[g]=new Array(d);for(var B=0;B<d;B+=1)f[g][B]=null}return f})(o),N(0,0),N(o-7,0),N(0,o-7),W(),O(),V(u,p),l>=7&&Q(u),b==null&&(b=Ie(l,m,h)),G(b,p)},N=function(u,p){for(var d=-1;d<=7;d+=1)if(!(u+d<=-1||o<=u+d))for(var f=-1;f<=7;f+=1)p+f<=-1||o<=p+f||(0<=d&&d<=6&&(f==0||f==6)||0<=f&&f<=6&&(d==0||d==6)||2<=d&&d<=4&&2<=f&&f<=4?a[u+d][p+f]=!0:a[u+d][p+f]=!1)},H=function(){for(var u=0,p=0,d=0;d<8;d+=1){_(!0,d);var f=s.getLostPoint(v);(d==0||u>f)&&(u=f,p=d)}return p},O=function(){for(var u=8;u<o-8;u+=1)a[u][6]==null&&(a[u][6]=u%2==0);for(var p=8;p<o-8;p+=1)a[6][p]==null&&(a[6][p]=p%2==0)},W=function(){for(var u=s.getPatternPosition(l),p=0;p<u.length;p+=1)for(var d=0;d<u.length;d+=1){var f=u[p],g=u[d];if(a[f][g]==null)for(var B=-2;B<=2;B+=1)for(var R=-2;R<=2;R+=1)B==-2||B==2||R==-2||R==2||B==0&&R==0?a[f+B][g+R]=!0:a[f+B][g+R]=!1}},Q=function(u){for(var p=s.getBCHTypeNumber(l),d=0;d<18;d+=1){var f=!u&&(p>>d&1)==1;a[Math.floor(d/3)][d%3+o-8-3]=f}for(var d=0;d<18;d+=1){var f=!u&&(p>>d&1)==1;a[d%3+o-8-3][Math.floor(d/3)]=f}},V=function(u,p){for(var d=m<<3|p,f=s.getBCHTypeInfo(d),g=0;g<15;g+=1){var B=!u&&(f>>g&1)==1;g<6?a[g][8]=B:g<8?a[g+1][8]=B:a[o-15+g][8]=B}for(var g=0;g<15;g+=1){var B=!u&&(f>>g&1)==1;g<8?a[8][o-g-1]=B:g<9?a[8][15-g-1+1]=B:a[8][15-g-1]=B}a[o-8][8]=!u},G=function(u,p){for(var d=-1,f=o-1,g=7,B=0,R=s.getMaskFunction(p),P=o-1;P>0;P-=2)for(P==6&&(P-=1);;){for(var L=0;L<2;L+=1)if(a[f][P-L]==null){var K=!1;B<u.length&&(K=(u[B]>>>g&1)==1);var U=R(f,P-L);U&&(K=!K),a[f][P-L]=K,g-=1,g==-1&&(B+=1,g=7)}if(f+=d,f<0||o<=f){f-=d,d=-d;break}}},te=function(u,p){for(var d=0,f=0,g=0,B=new Array(p.length),R=new Array(p.length),P=0;P<p.length;P+=1){var L=p[P].dataCount,K=p[P].totalCount-L;f=Math.max(f,L),g=Math.max(g,K),B[P]=new Array(L);for(var U=0;U<B[P].length;U+=1)B[P][U]=255&u.getBuffer()[U+d];d+=L;var z=s.getErrorCorrectPolynomial(K),J=c(B[P],z.getLength()-1),$e=J.mod(z);R[P]=new Array(z.getLength()-1);for(var U=0;U<R[P].length;U+=1){var Ke=U+$e.getLength()-R[P].length;R[P][U]=Ke>=0?$e.getAt(Ke):0}}for(var We=0,U=0;U<p.length;U+=1)We+=p[U].totalCount;for(var Se=new Array(We),ge=0,U=0;U<f;U+=1)for(var P=0;P<p.length;P+=1)U<B[P].length&&(Se[ge]=B[P][U],ge+=1);for(var U=0;U<g;U+=1)for(var P=0;P<p.length;P+=1)U<R[P].length&&(Se[ge]=R[P][U],ge+=1);return Se},Ie=function(u,p,d){for(var f=w.getRSBlocks(u,p),g=C(),B=0;B<d.length;B+=1){var R=d[B];g.put(R.getMode(),4),g.put(R.getLength(),s.getLengthInBits(R.getMode(),u)),R.write(g)}for(var P=0,B=0;B<f.length;B+=1)P+=f[B].dataCount;if(g.getLengthInBits()>P*8)throw"code length overflow. ("+g.getLengthInBits()+">"+P*8+")";for(g.getLengthInBits()+4<=P*8&&g.put(0,4);g.getLengthInBits()%8!=0;)g.putBit(!1);for(;!(g.getLengthInBits()>=P*8||(g.put(x,8),g.getLengthInBits()>=P*8));)g.put(y,8);return te(g,f)};v.addData=function(u,p){p=p||"Byte";var d=null;switch(p){case"Numeric":d=I(u);break;case"Alphanumeric":d=T(u);break;case"Byte":d=S(u);break;case"Kanji":d=M(u);break;default:throw"mode:"+p}h.push(d),b=null},v.isDark=function(u,p){if(u<0||o<=u||p<0||o<=p)throw u+","+p;return a[u][p]},v.getModuleCount=function(){return o},v.make=function(){if(l<1){for(var u=1;u<40;u++){for(var p=w.getRSBlocks(u,m),d=C(),f=0;f<h.length;f++){var g=h[f];d.put(g.getMode(),4),d.put(g.getLength(),s.getLengthInBits(g.getMode(),u)),g.write(d)}for(var B=0,f=0;f<p.length;f++)B+=p[f].dataCount;if(d.getLengthInBits()<=B*8)break}l=u}_(!1,H())},v.createTableTag=function(u,p){u=u||2,p=typeof p>"u"?u*4:p;var d="";d+='<table style="',d+=" border-width: 0px; border-style: none;",d+=" border-collapse: collapse;",d+=" padding: 0px; margin: "+p+"px;",d+='">',d+="<tbody>";for(var f=0;f<v.getModuleCount();f+=1){d+="<tr>";for(var g=0;g<v.getModuleCount();g+=1)d+='<td style="',d+=" border-width: 0px; border-style: none;",d+=" border-collapse: collapse;",d+=" padding: 0px; margin: 0px;",d+=" width: "+u+"px;",d+=" height: "+u+"px;",d+=" background-color: ",d+=v.isDark(f,g)?"#000000":"#ffffff",d+=";",d+='"/>';d+="</tr>"}return d+="</tbody>",d+="</table>",d},v.createSvgTag=function(u,p,d,f){var g={};typeof arguments[0]=="object"&&(g=arguments[0],u=g.cellSize,p=g.margin,d=g.alt,f=g.title),u=u||2,p=typeof p>"u"?u*4:p,d=typeof d=="string"?{text:d}:d||{},d.text=d.text||null,d.id=d.text?d.id||"qrcode-description":null,f=typeof f=="string"?{text:f}:f||{},f.text=f.text||null,f.id=f.text?f.id||"qrcode-title":null;var B=v.getModuleCount()*u+p*2,R,P,L,K,U="",z;for(z="l"+u+",0 0,"+u+" -"+u+",0 0,-"+u+"z ",U+='<svg version="1.1" xmlns="http://www.w3.org/2000/svg"',U+=g.scalable?"":' width="'+B+'px" height="'+B+'px"',U+=' viewBox="0 0 '+B+" "+B+'" ',U+=' preserveAspectRatio="xMinYMin meet"',U+=f.text||d.text?' role="img" aria-labelledby="'+Y([f.id,d.id].join(" ").trim())+'"':"",U+=">",U+=f.text?'<title id="'+Y(f.id)+'">'+Y(f.text)+"</title>":"",U+=d.text?'<description id="'+Y(d.id)+'">'+Y(d.text)+"</description>":"",U+='<rect width="100%" height="100%" fill="white" cx="0" cy="0"/>',U+='<path d="',L=0;L<v.getModuleCount();L+=1)for(K=L*u+p,R=0;R<v.getModuleCount();R+=1)v.isDark(L,R)&&(P=R*u+p,U+="M"+P+","+K+z);return U+='" stroke="transparent" fill="black"/>',U+="</svg>",U},v.createDataURL=function(u,p){u=u||2,p=typeof p>"u"?u*4:p;var d=v.getModuleCount()*u+p*2,f=p,g=d-p;return j(d,d,function(B,R){if(f<=B&&B<g&&f<=R&&R<g){var P=Math.floor((B-f)/u),L=Math.floor((R-f)/u);return v.isDark(L,P)?0:1}else return 1})},v.createImgTag=function(u,p,d){u=u||2,p=typeof p>"u"?u*4:p;var f=v.getModuleCount()*u+p*2,g="";return g+="<img",g+=' src="',g+=v.createDataURL(u,p),g+='"',g+=' width="',g+=f,g+='"',g+=' height="',g+=f,g+='"',d&&(g+=' alt="',g+=Y(d),g+='"'),g+="/>",g};var Y=function(u){for(var p="",d=0;d<u.length;d+=1){var f=u.charAt(d);switch(f){case"<":p+="&lt;";break;case">":p+="&gt;";break;case"&":p+="&amp;";break;case'"':p+="&quot;";break;default:p+=f;break}}return p},kt=function(u){var p=1;u=typeof u>"u"?p*2:u;var d=v.getModuleCount()*p+u*2,f=u,g=d-u,B,R,P,L,K,U={"\u2588\u2588":"\u2588","\u2588 ":"\u2580"," \u2588":"\u2584","  ":" "},z={"\u2588\u2588":"\u2580","\u2588 ":"\u2580"," \u2588":" ","  ":" "},J="";for(B=0;B<d;B+=2){for(P=Math.floor((B-f)/p),L=Math.floor((B+1-f)/p),R=0;R<d;R+=1)K="\u2588",f<=R&&R<g&&f<=B&&B<g&&v.isDark(P,Math.floor((R-f)/p))&&(K=" "),f<=R&&R<g&&f<=B+1&&B+1<g&&v.isDark(L,Math.floor((R-f)/p))?K+=" ":K+="\u2588",J+=u<1&&B+1>=g?z[K]:U[K];J+=`
`}return d%2&&u>0?J.substring(0,J.length-d-1)+Array(d+1).join("\u2580"):J.substring(0,J.length-1)};return v.createASCII=function(u,p){if(u=u||1,u<2)return kt(p);u-=1,p=typeof p>"u"?u*2:p;var d=v.getModuleCount()*u+p*2,f=p,g=d-p,B,R,P,L,K=Array(u+1).join("\u2588\u2588"),U=Array(u+1).join("  "),z="",J="";for(B=0;B<d;B+=1){for(P=Math.floor((B-f)/u),J="",R=0;R<d;R+=1)L=1,f<=R&&R<g&&f<=B&&B<g&&v.isDark(P,Math.floor((R-f)/u))&&(L=0),J+=L?K:U;for(P=0;P<u;P+=1)z+=J+`
`}return z.substring(0,z.length-1)},v.renderTo2dContext=function(u,p){p=p||2;for(var d=v.getModuleCount(),f=0;f<d;f++)for(var g=0;g<d;g++)u.fillStyle=v.isDark(f,g)?"black":"white",u.fillRect(f*p,g*p,p,p)},v};r.stringToBytesFuncs={default:function(A){for(var E=[],x=0;x<A.length;x+=1){var y=A.charCodeAt(x);E.push(y&255)}return E}},r.stringToBytes=r.stringToBytesFuncs.default,r.createStringToBytes=function(A,E){var x=(function(){for(var l=$(A),m=function(){var O=l.read();if(O==-1)throw"eof";return O},a=0,o={};;){var b=l.read();if(b==-1)break;var h=m(),v=m(),_=m(),N=String.fromCharCode(b<<8|h),H=v<<8|_;o[N]=H,a+=1}if(a!=E)throw a+" != "+E;return o})(),y=63;return function(l){for(var m=[],a=0;a<l.length;a+=1){var o=l.charCodeAt(a);if(o<128)m.push(o);else{var b=x[l.charAt(a)];typeof b=="number"?(b&255)==b?m.push(b):(m.push(b>>>8),m.push(b&255)):m.push(y)}}return m}};var e={MODE_NUMBER:1,MODE_ALPHA_NUM:2,MODE_8BIT_BYTE:4,MODE_KANJI:8},t={L:1,M:0,Q:3,H:2},n={PATTERN000:0,PATTERN001:1,PATTERN010:2,PATTERN011:3,PATTERN100:4,PATTERN101:5,PATTERN110:6,PATTERN111:7},s=(function(){var A=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],E=1335,x=7973,y=21522,l={},m=function(a){for(var o=0;a!=0;)o+=1,a>>>=1;return o};return l.getBCHTypeInfo=function(a){for(var o=a<<10;m(o)-m(E)>=0;)o^=E<<m(o)-m(E);return(a<<10|o)^y},l.getBCHTypeNumber=function(a){for(var o=a<<12;m(o)-m(x)>=0;)o^=x<<m(o)-m(x);return a<<12|o},l.getPatternPosition=function(a){return A[a-1]},l.getMaskFunction=function(a){switch(a){case n.PATTERN000:return function(o,b){return(o+b)%2==0};case n.PATTERN001:return function(o,b){return o%2==0};case n.PATTERN010:return function(o,b){return b%3==0};case n.PATTERN011:return function(o,b){return(o+b)%3==0};case n.PATTERN100:return function(o,b){return(Math.floor(o/2)+Math.floor(b/3))%2==0};case n.PATTERN101:return function(o,b){return o*b%2+o*b%3==0};case n.PATTERN110:return function(o,b){return(o*b%2+o*b%3)%2==0};case n.PATTERN111:return function(o,b){return(o*b%3+(o+b)%2)%2==0};default:throw"bad maskPattern:"+a}},l.getErrorCorrectPolynomial=function(a){for(var o=c([1],0),b=0;b<a;b+=1)o=o.multiply(c([1,i.gexp(b)],0));return o},l.getLengthInBits=function(a,o){if(1<=o&&o<10)switch(a){case e.MODE_NUMBER:return 10;case e.MODE_ALPHA_NUM:return 9;case e.MODE_8BIT_BYTE:return 8;case e.MODE_KANJI:return 8;default:throw"mode:"+a}else if(o<27)switch(a){case e.MODE_NUMBER:return 12;case e.MODE_ALPHA_NUM:return 11;case e.MODE_8BIT_BYTE:return 16;case e.MODE_KANJI:return 10;default:throw"mode:"+a}else if(o<41)switch(a){case e.MODE_NUMBER:return 14;case e.MODE_ALPHA_NUM:return 13;case e.MODE_8BIT_BYTE:return 16;case e.MODE_KANJI:return 12;default:throw"mode:"+a}else throw"type:"+o},l.getLostPoint=function(a){for(var o=a.getModuleCount(),b=0,h=0;h<o;h+=1)for(var v=0;v<o;v+=1){for(var _=0,N=a.isDark(h,v),H=-1;H<=1;H+=1)if(!(h+H<0||o<=h+H))for(var O=-1;O<=1;O+=1)v+O<0||o<=v+O||H==0&&O==0||N==a.isDark(h+H,v+O)&&(_+=1);_>5&&(b+=3+_-5)}for(var h=0;h<o-1;h+=1)for(var v=0;v<o-1;v+=1){var W=0;a.isDark(h,v)&&(W+=1),a.isDark(h+1,v)&&(W+=1),a.isDark(h,v+1)&&(W+=1),a.isDark(h+1,v+1)&&(W+=1),(W==0||W==4)&&(b+=3)}for(var h=0;h<o;h+=1)for(var v=0;v<o-6;v+=1)a.isDark(h,v)&&!a.isDark(h,v+1)&&a.isDark(h,v+2)&&a.isDark(h,v+3)&&a.isDark(h,v+4)&&!a.isDark(h,v+5)&&a.isDark(h,v+6)&&(b+=40);for(var v=0;v<o;v+=1)for(var h=0;h<o-6;h+=1)a.isDark(h,v)&&!a.isDark(h+1,v)&&a.isDark(h+2,v)&&a.isDark(h+3,v)&&a.isDark(h+4,v)&&!a.isDark(h+5,v)&&a.isDark(h+6,v)&&(b+=40);for(var Q=0,v=0;v<o;v+=1)for(var h=0;h<o;h+=1)a.isDark(h,v)&&(Q+=1);var V=Math.abs(100*Q/o/o-50)/5;return b+=V*10,b},l})(),i=(function(){for(var A=new Array(256),E=new Array(256),x=0;x<8;x+=1)A[x]=1<<x;for(var x=8;x<256;x+=1)A[x]=A[x-4]^A[x-5]^A[x-6]^A[x-8];for(var x=0;x<255;x+=1)E[A[x]]=x;var y={};return y.glog=function(l){if(l<1)throw"glog("+l+")";return E[l]},y.gexp=function(l){for(;l<0;)l+=255;for(;l>=256;)l-=255;return A[l]},y})();function c(A,E){if(typeof A.length>"u")throw A.length+"/"+E;var x=(function(){for(var l=0;l<A.length&&A[l]==0;)l+=1;for(var m=new Array(A.length-l+E),a=0;a<A.length-l;a+=1)m[a]=A[a+l];return m})(),y={};return y.getAt=function(l){return x[l]},y.getLength=function(){return x.length},y.multiply=function(l){for(var m=new Array(y.getLength()+l.getLength()-1),a=0;a<y.getLength();a+=1)for(var o=0;o<l.getLength();o+=1)m[a+o]^=i.gexp(i.glog(y.getAt(a))+i.glog(l.getAt(o)));return c(m,0)},y.mod=function(l){if(y.getLength()-l.getLength()<0)return y;for(var m=i.glog(y.getAt(0))-i.glog(l.getAt(0)),a=new Array(y.getLength()),o=0;o<y.getLength();o+=1)a[o]=y.getAt(o);for(var o=0;o<l.getLength();o+=1)a[o]^=i.gexp(i.glog(l.getAt(o))+m);return c(a,0).mod(l)},y}var w=(function(){var A=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12,7,37,13],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],E=function(l,m){var a={};return a.totalCount=l,a.dataCount=m,a},x={},y=function(l,m){switch(m){case t.L:return A[(l-1)*4+0];case t.M:return A[(l-1)*4+1];case t.Q:return A[(l-1)*4+2];case t.H:return A[(l-1)*4+3];default:return}};return x.getRSBlocks=function(l,m){var a=y(l,m);if(typeof a>"u")throw"bad rs block @ typeNumber:"+l+"/errorCorrectionLevel:"+m;for(var o=a.length/3,b=[],h=0;h<o;h+=1)for(var v=a[h*3+0],_=a[h*3+1],N=a[h*3+2],H=0;H<v;H+=1)b.push(E(_,N));return b},x})(),C=function(){var A=[],E=0,x={};return x.getBuffer=function(){return A},x.getAt=function(y){var l=Math.floor(y/8);return(A[l]>>>7-y%8&1)==1},x.put=function(y,l){for(var m=0;m<l;m+=1)x.putBit((y>>>l-m-1&1)==1)},x.getLengthInBits=function(){return E},x.putBit=function(y){var l=Math.floor(E/8);A.length<=l&&A.push(0),y&&(A[l]|=128>>>E%8),E+=1},x},I=function(A){var E=e.MODE_NUMBER,x=A,y={};y.getMode=function(){return E},y.getLength=function(a){return x.length},y.write=function(a){for(var o=x,b=0;b+2<o.length;)a.put(l(o.substring(b,b+3)),10),b+=3;b<o.length&&(o.length-b==1?a.put(l(o.substring(b,b+1)),4):o.length-b==2&&a.put(l(o.substring(b,b+2)),7))};var l=function(a){for(var o=0,b=0;b<a.length;b+=1)o=o*10+m(a.charAt(b));return o},m=function(a){if("0"<=a&&a<="9")return a.charCodeAt(0)-48;throw"illegal char :"+a};return y},T=function(A){var E=e.MODE_ALPHA_NUM,x=A,y={};y.getMode=function(){return E},y.getLength=function(m){return x.length},y.write=function(m){for(var a=x,o=0;o+1<a.length;)m.put(l(a.charAt(o))*45+l(a.charAt(o+1)),11),o+=2;o<a.length&&m.put(l(a.charAt(o)),6)};var l=function(m){if("0"<=m&&m<="9")return m.charCodeAt(0)-48;if("A"<=m&&m<="Z")return m.charCodeAt(0)-65+10;switch(m){case" ":return 36;case"$":return 37;case"%":return 38;case"*":return 39;case"+":return 40;case"-":return 41;case".":return 42;case"/":return 43;case":":return 44;default:throw"illegal char :"+m}};return y},S=function(A){var E=e.MODE_8BIT_BYTE,x=A,y=r.stringToBytes(A),l={};return l.getMode=function(){return E},l.getLength=function(m){return y.length},l.write=function(m){for(var a=0;a<y.length;a+=1)m.put(y[a],8)},l},M=function(A){var E=e.MODE_KANJI,x=A,y=r.stringToBytesFuncs.SJIS;if(!y)throw"sjis not supported.";(function(a,o){var b=y(a);if(b.length!=2||(b[0]<<8|b[1])!=o)throw"sjis not supported."})("\u53CB",38726);var l=y(A),m={};return m.getMode=function(){return E},m.getLength=function(a){return~~(l.length/2)},m.write=function(a){for(var o=l,b=0;b+1<o.length;){var h=(255&o[b])<<8|255&o[b+1];if(33088<=h&&h<=40956)h-=33088;else if(57408<=h&&h<=60351)h-=49472;else throw"illegal char at "+(b+1)+"/"+h;h=(h>>>8&255)*192+(h&255),a.put(h,13),b+=2}if(b<o.length)throw"illegal char at "+(b+1)},m},F=function(){var A=[],E={};return E.writeByte=function(x){A.push(x&255)},E.writeShort=function(x){E.writeByte(x),E.writeByte(x>>>8)},E.writeBytes=function(x,y,l){y=y||0,l=l||x.length;for(var m=0;m<l;m+=1)E.writeByte(x[m+y])},E.writeString=function(x){for(var y=0;y<x.length;y+=1)E.writeByte(x.charCodeAt(y))},E.toByteArray=function(){return A},E.toString=function(){var x="";x+="[";for(var y=0;y<A.length;y+=1)y>0&&(x+=","),x+=A[y];return x+="]",x},E},D=function(){var A=0,E=0,x=0,y="",l={},m=function(o){y+=String.fromCharCode(a(o&63))},a=function(o){if(!(o<0)){if(o<26)return 65+o;if(o<52)return 97+(o-26);if(o<62)return 48+(o-52);if(o==62)return 43;if(o==63)return 47}throw"n:"+o};return l.writeByte=function(o){for(A=A<<8|o&255,E+=8,x+=1;E>=6;)m(A>>>E-6),E-=6},l.flush=function(){if(E>0&&(m(A<<6-E),A=0,E=0),x%3!=0)for(var o=3-x%3,b=0;b<o;b+=1)y+="="},l.toString=function(){return y},l},$=function(A){var E=A,x=0,y=0,l=0,m={};m.read=function(){for(;l<8;){if(x>=E.length){if(l==0)return-1;throw"unexpected end of file./"+l}var o=E.charAt(x);if(x+=1,o=="=")return l=0,-1;if(o.match(/^\s$/))continue;y=y<<6|a(o.charCodeAt(0)),l+=6}var b=y>>>l-8&255;return l-=8,b};var a=function(o){if(65<=o&&o<=90)return o-65;if(97<=o&&o<=122)return o-97+26;if(48<=o&&o<=57)return o-48+52;if(o==43)return 62;if(o==47)return 63;throw"c:"+o};return m},ee=function(A,E){var x=A,y=E,l=new Array(A*E),m={};m.setPixel=function(h,v,_){l[v*x+h]=_},m.write=function(h){h.writeString("GIF87a"),h.writeShort(x),h.writeShort(y),h.writeByte(128),h.writeByte(0),h.writeByte(0),h.writeByte(0),h.writeByte(0),h.writeByte(0),h.writeByte(255),h.writeByte(255),h.writeByte(255),h.writeString(","),h.writeShort(0),h.writeShort(0),h.writeShort(x),h.writeShort(y),h.writeByte(0);var v=2,_=o(v);h.writeByte(v);for(var N=0;_.length-N>255;)h.writeByte(255),h.writeBytes(_,N,255),N+=255;h.writeByte(_.length-N),h.writeBytes(_,N,_.length-N),h.writeByte(0),h.writeString(";")};var a=function(h){var v=h,_=0,N=0,H={};return H.write=function(O,W){if(O>>>W)throw"length over";for(;_+W>=8;)v.writeByte(255&(O<<_|N)),W-=8-_,O>>>=8-_,N=0,_=0;N=O<<_|N,_=_+W},H.flush=function(){_>0&&v.writeByte(N)},H},o=function(h){for(var v=1<<h,_=(1<<h)+1,N=h+1,H=b(),O=0;O<v;O+=1)H.add(String.fromCharCode(O));H.add(String.fromCharCode(v)),H.add(String.fromCharCode(_));var W=F(),Q=a(W);Q.write(v,N);var V=0,G=String.fromCharCode(l[V]);for(V+=1;V<l.length;){var te=String.fromCharCode(l[V]);V+=1,H.contains(G+te)?G=G+te:(Q.write(H.indexOf(G),N),H.size()<4095&&(H.size()==1<<N&&(N+=1),H.add(G+te)),G=te)}return Q.write(H.indexOf(G),N),Q.write(_,N),Q.flush(),W.toByteArray()},b=function(){var h={},v=0,_={};return _.add=function(N){if(_.contains(N))throw"dup key:"+N;h[N]=v,v+=1},_.size=function(){return v},_.indexOf=function(N){return h[N]},_.contains=function(N){return typeof h[N]<"u"},_};return m},j=function(A,E,x){for(var y=ee(A,E),l=0;l<E;l+=1)for(var m=0;m<A;m+=1)y.setPixel(m,l,x(m,l));var a=F();y.write(a);for(var o=D(),b=a.toByteArray(),h=0;h<b.length;h+=1)o.writeByte(b[h]);return o.flush(),"data:image/gif;base64,"+o};return r})();(function(){it.stringToBytesFuncs["UTF-8"]=function(r){function e(t){for(var n=[],s=0;s<t.length;s++){var i=t.charCodeAt(s);i<128?n.push(i):i<2048?n.push(192|i>>6,128|i&63):i<55296||i>=57344?n.push(224|i>>12,128|i>>6&63,128|i&63):(s++,i=65536+((i&1023)<<10|t.charCodeAt(s)&1023),n.push(240|i>>18,128|i>>12&63,128|i>>6&63,128|i&63))}return n}return e(r)}})();(function(r){typeof define=="function"&&define.amd?define([],r):typeof ot=="object"&&(at.exports=r())})(function(){return it})});function Rt(r){return r instanceof Uint8Array||ArrayBuffer.isView(r)&&r.constructor.name==="Uint8Array"}function be(r,...e){if(!Rt(r))throw new Error("Uint8Array expected");if(e.length>0&&!e.includes(r.length))throw new Error("Uint8Array expected of length "+e+", got length="+r.length)}function Ee(r,e=!0){if(r.destroyed)throw new Error("Hash instance has been destroyed");if(e&&r.finished)throw new Error("Hash#digest() has already been called")}function qe(r,e){be(r);let t=e.outputLen;if(r.length<t)throw new Error("digestInto() expects output buffer of length at least "+t)}function de(...r){for(let e=0;e<r.length;e++)r[e].fill(0)}function ve(r){return new DataView(r.buffer,r.byteOffset,r.byteLength)}function X(r,e){return r<<32-e|r>>>e}function Ut(r){if(typeof r!="string")throw new Error("string expected");return new Uint8Array(new TextEncoder().encode(r))}function Be(r){return typeof r=="string"&&(r=Ut(r)),be(r),r}var ye=class{};function Ve(r){let e=n=>r().update(Be(n)).digest(),t=r();return e.outputLen=t.outputLen,e.blockLen=t.blockLen,e.create=()=>r(),e}function _t(r,e,t,n){if(typeof r.setBigUint64=="function")return r.setBigUint64(e,t,n);let s=BigInt(32),i=BigInt(4294967295),c=Number(t>>s&i),w=Number(t&i),C=n?4:0,I=n?0:4;r.setUint32(e+C,c,n),r.setUint32(e+I,w,n)}function Ge(r,e,t){return r&e^~r&t}function Qe(r,e,t){return r&e^r&t^e&t}var xe=class extends ye{constructor(e,t,n,s){super(),this.finished=!1,this.length=0,this.pos=0,this.destroyed=!1,this.blockLen=e,this.outputLen=t,this.padOffset=n,this.isLE=s,this.buffer=new Uint8Array(e),this.view=ve(this.buffer)}update(e){Ee(this),e=Be(e),be(e);let{view:t,buffer:n,blockLen:s}=this,i=e.length;for(let c=0;c<i;){let w=Math.min(s-this.pos,i-c);if(w===s){let C=ve(e);for(;s<=i-c;c+=s)this.process(C,c);continue}n.set(e.subarray(c,c+w),this.pos),this.pos+=w,c+=w,this.pos===s&&(this.process(t,0),this.pos=0)}return this.length+=e.length,this.roundClean(),this}digestInto(e){Ee(this),qe(e,this),this.finished=!0;let{buffer:t,view:n,blockLen:s,isLE:i}=this,{pos:c}=this;t[c++]=128,de(this.buffer.subarray(c)),this.padOffset>s-c&&(this.process(n,0),c=0);for(let S=c;S<s;S++)t[S]=0;_t(n,s-8,BigInt(this.length*8),i),this.process(n,0);let w=ve(e),C=this.outputLen;if(C%4)throw new Error("_sha2: outputLen should be aligned to 32bit");let I=C/4,T=this.get();if(I>T.length)throw new Error("_sha2: outputLen bigger than state");for(let S=0;S<I;S++)w.setUint32(4*S,T[S],i)}digest(){let{buffer:e,outputLen:t}=this;this.digestInto(e);let n=e.slice(0,t);return this.destroy(),n}_cloneInto(e){e||(e=new this.constructor),e.set(...this.get());let{blockLen:t,buffer:n,length:s,finished:i,destroyed:c,pos:w}=this;return e.destroyed=c,e.finished=i,e.length=s,e.pos=w,s%t&&e.buffer.set(n),e}clone(){return this._cloneInto()}},re=Uint32Array.from([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]);var Nt=Uint32Array.from([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]),ie=new Uint32Array(64),Te=class extends xe{constructor(e=32){super(64,e,8,!1),this.A=re[0]|0,this.B=re[1]|0,this.C=re[2]|0,this.D=re[3]|0,this.E=re[4]|0,this.F=re[5]|0,this.G=re[6]|0,this.H=re[7]|0}get(){let{A:e,B:t,C:n,D:s,E:i,F:c,G:w,H:C}=this;return[e,t,n,s,i,c,w,C]}set(e,t,n,s,i,c,w,C){this.A=e|0,this.B=t|0,this.C=n|0,this.D=s|0,this.E=i|0,this.F=c|0,this.G=w|0,this.H=C|0}process(e,t){for(let S=0;S<16;S++,t+=4)ie[S]=e.getUint32(t,!1);for(let S=16;S<64;S++){let M=ie[S-15],F=ie[S-2],D=X(M,7)^X(M,18)^M>>>3,$=X(F,17)^X(F,19)^F>>>10;ie[S]=$+ie[S-7]+D+ie[S-16]|0}let{A:n,B:s,C:i,D:c,E:w,F:C,G:I,H:T}=this;for(let S=0;S<64;S++){let M=X(w,6)^X(w,11)^X(w,25),F=T+M+Ge(w,C,I)+Nt[S]+ie[S]|0,$=(X(n,2)^X(n,13)^X(n,22))+Qe(n,s,i)|0;T=I,I=C,C=w,w=c+F|0,c=i,i=s,s=n,n=F+$|0}n=n+this.A|0,s=s+this.B|0,i=i+this.C|0,c=c+this.D|0,w=w+this.E|0,C=C+this.F|0,I=I+this.G|0,T=T+this.H|0,this.set(n,s,i,c,w,C,I,T)}roundClean(){de(ie)}destroy(){this.set(0,0,0,0,0,0,0,0),de(this.buffer)}};var ze=Ve(()=>new Te);function Pe(){let r=new Uint8Array(32);return crypto.getRandomValues(r),Array.from(r,e=>e.toString(16).padStart(2,"0")).join("")}var Mt="privasys.id",Re="relay.privasys.org",Ue=1;function Dt(r){let e="";for(let t=0;t<r.length;t++)e+=String.fromCharCode(r[t]);return btoa(e).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Je(r){return Dt(ze(new TextEncoder().encode(r)).subarray(0,16))}function Ye(r){try{return new URL(r).host}catch{return Re}}function Xe(r){try{let e=new URL(r);return`${e.protocol==="wss:"?"https:":e.protocol==="ws:"?"http:":e.protocol}//${e.host}`}catch{return`https://${Re}`}}function Ze(r,e,t){let n=t===Re?"":`&r=${encodeURIComponent(t)}`;return`https://${Mt}/scp?v=${Ue}&s=${encodeURIComponent(r)}&h=${e}${n}`}async function et(r,e,t){let n=`${r}/connect/${encodeURIComponent(e)}`;try{let s=await fetch(n,{method:"PUT",headers:{"Content-Type":"application/json"},body:t});s.ok||console.warn(`[privasys-auth] descriptor publish returned ${s.status} from ${n}`)}catch(s){console.warn("[privasys-auth] descriptor publish failed",s)}}function tt(r){let e=r.sessionId??Pe(),t={v:Ue,origin:r.rpId,sessionId:e,rpId:r.rpId,brokerUrl:r.brokerUrl};if(r.requestedAttributes?.length&&(t.requestedAttributes=r.requestedAttributes),r.appName&&(t.appName=r.appName),r.privacyPolicyUrl&&(t.privacyPolicyUrl=r.privacyPolicyUrl),r.mode==="session-relay"){if(!r.sdkPub||!r.appHost)throw new Error("generateQRPayload: session-relay mode requires sdkPub and appHost");t.mode="session-relay",t.sdkPub=r.sdkPub,t.appHost=r.appHost,r.nonce&&(t.nonce=r.nonce)}let n=JSON.stringify(t),s=Je(n),i=r.relayBase??Xe(r.brokerUrl),c=r.relayBase?new URL(r.relayBase).host:Ye(r.brokerUrl),w=Ze(e,s,c),C=et(i,e,n);return{sessionId:e,payload:w,descriptorPublished:C,descriptorHash:s}}function rt(r){let e=r.sessionId??Pe(),t=r.apps.map(T=>({rpId:T.rpId,sessionId:T.sessionId??Pe()})),n={v:Ue,origin:r.apps[0]?.rpId??"",sessionId:e,brokerUrl:r.brokerUrl,apps:t},s=JSON.stringify(n),i=Je(s),c=r.relayBase??Xe(r.brokerUrl),w=r.relayBase?new URL(r.relayBase).host:Ye(r.brokerUrl),C=Ze(e,i,w),I=et(c,e,s);return{sessionId:e,appSessions:t,payload:C,descriptorPublished:I,descriptorHash:i}}var _e="privasys_sessions",Ne="privasys_device_hints",nt="privasys_passkey",oe=class{constructor(){this.listeners=new Set}store(e){let t=this.getAll(),n=t.findIndex(s=>s.rpId===e.rpId);n>=0?t[n]=e:t.push(e),this.persist(t),this.notify(t)}get(e){return this.getAll().find(t=>t.rpId===e)}getAll(){try{let e=localStorage.getItem(_e);return e?JSON.parse(e):[]}catch{return[]}}has(e){return this.get(e)!==void 0}findPushToken(){let e=this.getAll().filter(t=>!!t.pushToken).sort((t,n)=>n.authenticatedAt-t.authenticatedAt);return e[0]?.pushToken?e[0].pushToken:this.getDeviceHint()?.pushToken}remove(e){let t=this.getAll().filter(n=>n.rpId!==e);this.persist(t),this.notify(t)}clear(){localStorage.removeItem(_e),this.notify([])}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}saveDeviceHint(e,t){let n={pushToken:e,brokerUrl:t,updatedAt:Date.now()};try{localStorage.setItem(Ne,JSON.stringify(n))}catch{}}getDeviceHint(){try{let e=localStorage.getItem(Ne);return e?JSON.parse(e):void 0}catch{return}}clearDeviceHint(){localStorage.removeItem(Ne)}savePasskeyHint(){try{localStorage.setItem(nt,"1")}catch{}}hasPasskeyHint(){try{return localStorage.getItem(nt)==="1"}catch{return!1}}persist(e){localStorage.setItem(_e,JSON.stringify(e))}notify(e){for(let t of this.listeners)t(e)}};var Me=12e4,me=class{constructor(e,t={}){this.activeConnections=new Map;this.config={attestation:"required",timeout:Me,...e},this.events=t,this.sessions=new oe}createQR(e,t){return tt({rpId:this.config.rpId,brokerUrl:this.config.brokerUrl,sessionId:e,requestedAttributes:this.config.requestedAttributes,appName:this.config.appName,privacyPolicyUrl:this.config.privacyPolicyUrl,...t?{mode:"session-relay",sdkPub:t.sdkPub,appHost:t.appHost,nonce:t.nonce}:{}})}waitForResult(e){return new Promise((t,n)=>{let s=this.config.timeout??Me,i=new URL(this.config.brokerUrl);i.searchParams.set("session",e),i.searchParams.set("role","browser");let c=new WebSocket(i.toString());this.activeConnections.set(e,c),this.setState("waiting-for-scan");let w=setTimeout(()=>{this.setState("timeout"),this.cleanup(e),n(new Error("Authentication timed out"))},s);c.onopen=()=>{this.setState("waiting-for-scan")},c.onmessage=C=>{try{let I=JSON.parse(typeof C.data=="string"?C.data:"{}");this.handleMessage(e,I,t,w)}catch{}},c.onerror=()=>{clearTimeout(w),this.setState("error"),this.cleanup(e),n(new Error("WebSocket connection failed"))},c.onclose=C=>{clearTimeout(w),this.cleanup(e),C.code!==1e3&&(this.setState("error"),n(new Error(`Connection closed (code ${C.code})`)))}})}async notifyAndWait(e,t){let n=t??this.createQR().sessionId,s=this.config.brokerUrl.replace("wss://","https://").replace("ws://","http://").replace(/\/relay\/?$/,""),i=await fetch(`${s}/notify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({pushToken:e,sessionId:n,rpId:this.config.rpId,appName:this.config.appName,origin:this.config.rpId,brokerUrl:this.config.brokerUrl})});if(!i.ok){let c=await i.text();throw new Error(`Push notification failed: ${c}`)}return this.waitForResult(n)}cancel(e){this.cleanup(e),this.setState("idle")}destroy(){for(let e of this.activeConnections.keys())this.cleanup(e);this.setState("idle")}getMultiple(e){let{sessionId:t,appSessions:n,payload:s}=rt({brokerUrl:this.config.brokerUrl,apps:e.map(c=>({rpId:c.rpId}))}),i=this.waitForBatch(n);return{sessionId:t,appSessions:n,payload:s,result:i}}on(e){this.events={...this.events,...e}}handleMessage(e,t,n,s){switch(t.type){case"peer-joined":case"wallet-waiting":this.setState("wallet-connected");break;case"auth-result":{clearTimeout(s),this.setState("complete");let i={sessionToken:t.sessionToken,sessionId:e,attestation:t.attestation,pushToken:t.pushToken||void 0,attributes:t.attributes||void 0,sessionRelay:t.sessionRelay||void 0};this.sessions.store({token:i.sessionToken,rpId:this.config.rpId,origin:globalThis.location?.origin??"",authenticatedAt:Date.now(),pushToken:i.pushToken,brokerUrl:this.config.brokerUrl}),this.events.onAuthenticated?.(i),this.cleanup(e),n(i);break}case"auth-error":{clearTimeout(s),this.setState("error"),this.cleanup(e);let i=new Error(t.message??"Authentication failed");this.events.onError?.(i);break}case"authenticating":this.setState("authenticating");break}}setState(e){this.events.onStateChange?.(e)}async waitForBatch(e){let t=this.config.timeout??Me;this.setState("waiting-for-scan");let n=await Promise.allSettled(e.map(c=>Promise.race([this.waitForResult(c.sessionId),new Promise((w,C)=>setTimeout(()=>C(new Error("Batch item timed out")),t))]))),s=[],i=[];for(let c=0;c<n.length;c++){let w=n[c];w.status==="fulfilled"?s.push(w.value):i.push({rpId:e[c].rpId,error:w.reason instanceof Error?w.reason.message:String(w.reason)})}return this.setState(i.length===0?"complete":"error"),{results:s,errors:i}}cleanup(e){let t=this.activeConnections.get(e);t&&((t.readyState===WebSocket.OPEN||t.readyState===WebSocket.CONNECTING)&&t.close(1e3),this.activeConnections.delete(e))}};function Z(r){let e=new Uint8Array(r),t="";for(let n=0;n<e.length;n++)t+=String.fromCharCode(e[n]);return btoa(t).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function he(r){let e=r.replace(/-/g,"+").replace(/_/g,"/");for(;e.length%4!==0;)e+="=";let t=atob(e),n=new Uint8Array(t.length);for(let s=0;s<t.length;s++)n[s]=t.charCodeAt(s);return n.buffer}function st(r){let e=new Uint8Array(r);return crypto.getRandomValues(e),Array.from(e,t=>t.toString(16).padStart(2,"0")).join("")}var ae=class{constructor(e,t={}){this.state="idle";this.config={timeout:6e4,...e},this.events=t,this.sessions=new oe}on(e){this.events={...this.events,...e}}getState(){return this.state}async register(e){this.setState("requesting-options");try{let t=Z(crypto.getRandomValues(new Uint8Array(32)).buffer),n=this.config.sessionId??st(16),i=(await this.fido2Fetch("register/begin",{userName:e??globalThis.location?.hostname??"user",userHandle:t},{session_id:n})).publicKey;if(!i)throw new Error("Missing publicKey in registration options");let c={publicKey:{challenge:he(i.challenge),rp:{id:i.rp.id,name:i.rp.name},user:{id:he(i.user.id),name:i.user.name,displayName:i.user.displayName??i.user.name},pubKeyCredParams:(i.pubKeyCredParams??[]).map(T=>({type:T.type??"public-key",alg:T.alg})),timeout:this.config.timeout,attestation:i.attestation??"none",authenticatorSelection:{authenticatorAttachment:"platform",residentKey:"required",userVerification:i.authenticatorSelection?.userVerification??"required"},...i.excludeCredentials?{excludeCredentials:i.excludeCredentials.map(T=>({type:"public-key",id:he(T.id)}))}:{}}};this.setState("ceremony");let w=await navigator.credentials.create(c);if(!w)throw new Error("No credential returned");this.setState("verifying");let C=w.response,I=await this.fido2Fetch("register/complete",{id:Z(w.rawId),rawId:Z(w.rawId),type:"public-key",response:{attestationObject:Z(C.attestationObject),clientDataJSON:Z(C.clientDataJSON)}},{challenge:i.challenge});return this.sessions.savePasskeyHint(),this.complete(I.sessionToken??"",n)}catch(t){return this.fail(t)}}async authenticate(){this.setState("requesting-options");try{let e=this.config.sessionId??st(16),n=(await this.fido2Fetch("authenticate/begin",{},{session_id:e})).publicKey;if(!n)throw new Error("Missing publicKey in authentication options");let s={publicKey:{challenge:he(n.challenge),rpId:n.rpId,timeout:this.config.timeout,userVerification:n.userVerification??"preferred",...n.allowCredentials?.length?{allowCredentials:n.allowCredentials.map(I=>({type:"public-key",id:he(I.id),...I.transports?.length?{transports:I.transports}:{}}))}:{}}};this.setState("ceremony");let i=await navigator.credentials.get(s);if(!i)throw new Error("No assertion returned");this.setState("verifying");let c=i.response,w={clientDataJSON:Z(c.clientDataJSON),authenticatorData:Z(c.authenticatorData),signature:Z(c.signature)};c.userHandle&&c.userHandle.byteLength>0&&(w.userHandle=Z(c.userHandle));let C=await this.fido2Fetch("authenticate/complete",{id:Z(i.rawId),rawId:Z(i.rawId),type:"public-key",response:w},{challenge:n.challenge});return this.complete(C.sessionToken??"",e)}catch(e){return this.fail(e)}}static isSupported(){return typeof globalThis.PublicKeyCredential<"u"}async fido2Fetch(e,t,n){let s=(this.config.fido2Base??this.config.apiBase).replace(/\/+$/,""),i=this.config.fido2Base?new URL(`${s}/${e}`):new URL(`${s}/api/v1/apps/${encodeURIComponent(this.config.appName)}/fido2/${e}`);if(n)for(let[w,C]of Object.entries(n))i.searchParams.set(w,C);let c=await fetch(i.toString(),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!c.ok){let w=await c.json().catch(()=>({error:c.statusText}));throw new Error(w.error??`HTTP ${c.status}`)}return c.json()}complete(e,t){this.setState("complete");let n={sessionToken:e,sessionId:t};return this.sessions.store({token:e,rpId:this.config.appName,origin:globalThis.location?.origin??"",authenticatedAt:Date.now()}),this.events.onAuthenticated?.(n),n}fail(e){this.setState("error");let t=e instanceof Error?e.name==="NotAllowedError"?new Error("Credential operation was cancelled or timed out"):e:new Error(String(e));throw this.events.onError?.(t),t}setState(e){this.state=e,this.events.onStateChange?.(e)}};var dt=Pt(ct(),1),Ht=`
:host {
    all: initial;
    position: fixed;
    inset: 0;
