        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-6">
            ...
            <div className="w-full max-w-sm p-8 rounded-2xl border border-black/10 dark:border-white/10">
                ...
                <button
                    ...
                    className="mt-8 w-full flex items-center justify-center gap-2.5 px-4 py-2.5 text-sm font-medium rounded-lg bg-[#24292f] text-white hover:bg-[#32383f] transition-colors disabled:opacity-50"
                >
