...
export default function NewApplicationPage() {
    ...
    // Container apps (package/cloud_image sources are container-only) get the
    // vault-backed persistent volume; the VM size is chosen at deploy time.
    ...
    }, [session?.accessToken, sourceMode, name, friendlyName, parsed, file, commitUrl, submitting, appType, containerImage, cloudImageName, cloudImageChannel, description, category, tagline, storeExtra, isContainerApp]);
