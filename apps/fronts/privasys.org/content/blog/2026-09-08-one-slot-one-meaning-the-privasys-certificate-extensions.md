...
*The scheme is documented [here](https://docs.privasys.org/solutions/enclave-os/attestation/oids/) and generated from `oids.json` in [github.com/Privasys/ra-tls-clients](https://github.com/Privasys/ra-tls-clients), which also holds the SDKs that read it, under the AGPL-3.0 licence.*
